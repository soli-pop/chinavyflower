...
const colors = [
  "#1f3b5a", // deep navy (replacement for #ba3763)
  "#335678", // medium navy (replacement for #d34076)
  "#7a9ec9", // soft sky blue (replacement for #dbb0cc)
  "#cfe3f6", // very light blue (replacement for #fddafa)
  "#f0f6fc", // almost white blue (replacement for #fef2fe)
  "#9bb8dd", // muted blue (replacement for #eec0db)
  "#5a7fa6", // slightly warm mid blue (replacement for #ca809a)
  "#d6e1f2"  // pale icy blue (replacement for #e9d8e8)
];
